...
- **记货**：分步引导（发生了什么 → 我怎么想 → 一句话判断）+ 今日三问治白纸障碍 + 标签 + 拍照
- **AI 造货教练**：卡住时追问你"为什么"、检测你的"套话"（只追问、只判定，不代答）
- **货库**：缩略卡片 → 展开三行全文，可编辑、再挖一层、再查套话、删除
- **出货练习**：选一条货 + 选真实场景，AI 扮听众陪你"说"（只追问/复述/点结构，不代写）
- **回看**：1 / 3 / 7 / 14 / 30 天前的旧货自动浮现 + 记今日新想法
- **进步**：连续天数、打卡日历、里程碑庆祝
- **备份**：JSON 一键导出 / 导入
...
src/
  ...
  components/        # SetupGuide 引导、ShipPractice 出货练习
...
> **表达能力的根，是"从生活里持续造货"的能力；但货造出来不"说"出去，就还是死的。** 造货（往内挖）和出货（往外说），构成完整的训练闭环。

所以 AI 教练只追问、不代答、不当写手——一旦 AI 替你思考或代写成稿，你就练不到"自己想、自己说"了。
